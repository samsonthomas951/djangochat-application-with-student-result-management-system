...
from .views import ( SubjectCreateView, subjectlistview,SubjectDeleteView,SubjectCombinationListView,SubjectUpdateView,SubjectCombinationUpdateView,SubjectCombinationCreateView,SubjectCombinationDeleteView)
